...
option_list = list(
  ...
  help="Input GO file, each gene may be represented by several GO on several lines [default= %default]", metavar="character"), 
  make_option(c("-O", "--out"), type="character", default="", 
  help="Formatted output file, one gene=one line with GOs separated by semicolons [default= %default]", metavar="character")
)
